...
public class Wrapper implements AppConstants {
    ...
    public WebBrowser openSF_Application() throws Exception {
        // WebBrowser chromeBrowser = testcreateMinimalChrome();
     	WebBrowser chromeBrowser = createMinimalChrome_SF();
     	
         chromeBrowser.openPageByURL("https://c.na78.visual.force.com/apex/accountpage");
         //chromeBrowser.openPageByURL("http://google.com");
    ...
    public void login_SF(WebBrowser app) throws Exception {
        String except = "false";
    	...
    	try {
    		app.getActions().click(By.id("Login"), TimeoutType.DEFAULT);
    		System.out.println("Login button clicked Sucessfully");
    	}catch(Exception e) {
    		System.out.println("Unable to click the login button : "+e.getMessage());
    		except = "true";
    	...
    	/*try {
    		app.getActions().verifyElementVisible(By.xpath("//*[text()='My Content']"),TimeoutType.TWENTY_SECONDS);
    		System.out.println("Home page loaded Sucessfully");
    ...
    private WebBrowser createMinimalChrome_SF() throws JiveWebDriverException {
        return RemoteBrowserBuilder.getBuilder(WebBrowserType.CHROME, "https://c.na78.visual.force.com/apex/accountpage", "http://172.31.63.151:4444/wd/hub")
        		//.withWebDriverPath("C:\\Users\\Shahed\\Downloads\\chromedriver_win32\\chromedriver.exe")
        		.withWebDriverPath("C:\\selenium\\chromedriver.exe")
    ...
    private WebBrowser testcreateMinimalChrome() throws JiveWebDriverException {
        return LocalBrowserBuilder.getBuilder(WebBrowserType.CHROME, "https://c.na78.visual.force.com/apex/accountpage")
        		.withWebDriverPath("C:\\Users\\Shahed\\Downloads\\chromedriver_win32\\chromedriver.exe")
        		//.withWebDriverPath("C:\\selenium\\chromedriver.exe")
